...
#include <shader.h>
  ...
  * \brief A wrapper class for a WebGPU shader module.
  *
  * \details This class provides a simple interface for loading and managing a WebGPU shader module.
  * It handles the creation and destruction of the underlying WGPUShaderModule.
  */
class Shader {
public:
