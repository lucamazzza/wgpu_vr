...
grado di interrogare l'oggetto \texttt{context} all'interno di \texttt{WebGPU}. Ciò permette di forzare l'astrazione
e di risalire all'istanza Vulkan nativa, restituendola all'API C++ sottoforma di puntatore opaco.

\begin{listing}[!ht]
\begin{minted}{rust}
#[no_mangle]
pub unsafe extern "C" fn wgpuDeviceGetVulkanDevice(
