...
la transizione architetturale verso nuovi standard aperti, come \texttt{OpenXR} e \texttt{WebGPU}
...
\section{Frammentazione - \texttt{Vulkan}, \texttt{DirectX12} \& \texttt{Metal}}
