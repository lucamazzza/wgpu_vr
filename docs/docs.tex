...
\texttt{R-00} & Deve presentare un backend \texttt{WebGPU}, con \texttt{wgpu\_native}, in \texttt{C++}  & Supporta <\texttt{C++20}\\
\texttt{R-01} & Deve presentare l'integrazione di \texttt{OpenXR} per gestire funzionalità VR           & -                       \\
...
\texttt{R-07} & Deve includere analisi complessità, comparata a soluzione \texttt{OpenGL}               & -                       \\
