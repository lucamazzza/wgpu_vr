...
L'unico metodo per aggirare questo limit4e consiste nella modifica diretta e ricompilazione del codice sorgente
...
spostato su \textbf{\texttt{Dawn}}, implementazione in \texttt{C++} di WebGPU sviluppata da Google ed utilizzata come
backend per il browser \textit{\gls{Chromium}}. Architetturalmente, \texttt{Dawn} presenta una scelta più promettente:
...
Il sistema finale implementato si regge di conseguenza su un drastico compromesso tecnico, il quale indipendentemente
